...
class BaumerCamera::DataStream::Impl
{
public:
...
//  }
//
//  auto StartFrameGrabber() -> FrameGrabber
//  {
//     return ;
//  }
//
...
auto BaumerCamera::GetAvailableCameras() -> std::vector<BaumerCamera::DataStream>&
{
   return _pImpl->GetAvailableCameras();
}

BaumerCamera::DataStream::~DataStream() = default;
BaumerCamera::DataStream::DataStream(BaumerCamera::DataStream&&) noexcept = default;
BaumerCamera::DataStream& BaumerCamera::DataStream::operator=(BaumerCamera::DataStream&&) noexcept = default;

BaumerCamera::DataStream::DataStream(std::unique_ptr<Impl>&& pImpl)
   : _pImpl{std::move(pImpl)}
{
}

void BaumerCamera::DataStream::StartCamera()
{
   _pImpl->StartCamera();
}

void BaumerCamera::DataStream::StopCamera()
{
   _pImpl->StopCamera();
}

bool BaumerCamera::DataStream::GetFrame(cv::Mat& frame)
{
